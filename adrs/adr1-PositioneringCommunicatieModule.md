Bot toevoegen --> ja (Deze controleert de pull requesten). --> sonar club cloud --> Ook op de CI/CD

Hoe willen wij testen? 
- Unittesten            Ja
...
SaaS-Skaalbaarheid: Als zelfstandig product kunnen we updates (zoals een nieuwe provider-koppeling) in één keer uitrollen voor alle organisaties, zonder dat zij hun lokale OpenMRS-server hoeven te herstarten of updaten.
